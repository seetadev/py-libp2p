...
1. **Shift rows**, cyclic shift left of all rows of data array
1. **Mix columns**, multiplying every column by fixed polynomial
1. **Add round key**, round_key xor i-th column of array
